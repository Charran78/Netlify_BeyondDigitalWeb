        ...
        return (
          <div className="text-center space-y-8 py-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
              <span className="inline-block text-blue-500 font-semibold text-xl md:text-2xl leading-tight break-words w-full text-center my-2">Oracle Cloud Infrastructure 2025 Generative AI Professional</span>
